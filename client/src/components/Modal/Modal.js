            ...
            <div className="mt-3 flex justify-center">
              ...
              <div className="mt-2 text-center sm:ml-4 sm:text-left flex flex-col items-center">
                ...
                <div className="items-center gap-2 mt-3 sm:flex">
                  ...
                  <button
                    className="w-full mt-2 p-2.5 flex-1 text-gray-800 rounded-md outline-none border ring-offset-2 ring-indigo-600 focus:ring-2 hover:bg-crimson transition-all	duration-1000"
                    onClick={() => setOpenModal(false)}
                  >
                    Close
                  </button>
